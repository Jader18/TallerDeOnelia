        ...
        <section class="evento-detalle">
            <div class="container">
                ...
                <div class="galeria-adicional">
                    <div class="foto-card">
                        <img src="../assets/img/eventos/empresarial/empresarial1.jpg" alt="Foto adicional 1">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/empresarial/empresarial2.jpg" alt="Foto adicional 2">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/empresarial/empresarial3.jpg" alt="Foto adicional 3">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/empresarial/empresarial4.jpg" alt="Foto adicional 4">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/empresarial/empresarial5.jpg" alt="Foto adicional 5">
                    </div>
                </div>
