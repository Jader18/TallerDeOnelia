        ...
        <section class="evento-detalle">
            <div class="container">
                ...
                <div class="galeria-adicional">
                    <div class="foto-card">
                        <img src="../assets/img/eventos/cumple/cumple1.jpeg" alt="Foto adicional 1">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/cumple/cumple2.jpg" alt="Foto adicional 2">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/cumple/cumple3.jpg" alt="Foto adicional 3">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/cumple/cumple4.jpeg" alt="Foto adicional 4">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/cumple/cumple5.jpg" alt="Foto adicional 5">
                    </div>
                </div>
