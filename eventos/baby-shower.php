        ...
        <section class="evento-detalle">
            <div class="container">
                ...
                <div class="evento-header">
                    ...
                    <span class="evento-badge">Celebración Especial</span>
                </div>
                ...
                <div class="evento-grid">
                    ...
                    <div class="evento-imagen-principal">
                        <img src="../assets/img/tipos-eventos/1.jpg"
                    ...
                    <div class="evento-info-card">
                        ...
                        <div class="evento-descripcion">
                            <?= nl2br(htmlspecialchars($evento['descripcion'] ?: 'Celebra la llegada de tu bebé con una decoración tierna y memorable. Diseñamos ambientes acogedores con temáticas personalizadas que harán de tu baby shower un momento inolvidable.')) ?>
                        </div>
                        ...
                        <ul class="evento-detalles-lista">
                            ...
                            <li>
                                ...
                                <div class="detalle-contenido">
                                    ...
                                    <span>Ositos, sirenas, safari, y más</span>
                                </div>
                            </li>
                            <li>
                                <div class="detalle-icono">🎁</div>
                                <div class="detalle-contenido">
                                    ...
                                    <span>Mesa de regalos decorada</span>
                                </div>
                            </li>
                        </ul>
                ...
                <div class="galeria-titulo">
                    ...
                    <p>Algunos de nuestros trabajos anteriores en baby showers</p>
                </div>
                
                <div class="galeria-adicional">
                    <div class="foto-card">
                        <img src="../assets/img/eventos/babyshower/babyshower1.jpg" alt="Baby shower 1" loading="lazy">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/babyshower/babyshower2.jpg" alt="Baby shower 2" loading="lazy">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/babyshower/babyshower3.jpg" alt="Baby shower 3" loading="lazy">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/babyshower/babyshower4.jpeg" alt="Baby shower 4" loading="lazy">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/babyshower/babyshower5.jpeg" alt="Baby shower 5" loading="lazy">
                    </div>
                </div>
                
                <!-- Preguntas frecuentes específicas -->
                <div class="evento-faq">
                    <h3>Preguntas frecuentes para Baby Shower</h3>
                    <div class="faq-grid">
                        <div class="faq-item">
                            <h4>🎀 ¿Qué temáticas ofrecen?</h4>
                            <p>Trabajamos con temáticas populares como ositos, sirenas, safari, elefantes, y también creamos diseños personalizados según tus preferencias.</p>
                        </div>
                        <div class="faq-item">
                            <h4>🎂 ¿Incluye pastel o catering?</h4>
                            <p>Nuestro servicio es exclusivamente de decoración. Podemos recomendarte proveedores de confianza para pasteles y catering.</p>
                        </div>
                        <div class="faq-item">
                            <h4>📦 ¿Qué incluye el paquete?</h4>
                            <p>Incluye decoración del área principal, mesa de regalos, centros de mesa, y detalles decorativos acordes a la temática elegida.</p>
                        </div>
                        <div class="faq-item">
                            <h4>👶 ¿Hacen decoración para revelación de género?</h4>
                            <p>¡Sí! También decoramos fiestas de revelación de género con elementos sorpresa como globos con confeti, pasteles personalizados y más.</p>
                        </div>
                    </div>
                </div>
