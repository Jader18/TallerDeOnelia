        ...
        <section class="evento-detalle">
            <div class="container">
                ...
                <div class="galeria-adicional">
                    <div class="foto-card">
                        <img src="../assets/img/eventos/babyshower/babyshower1.jpg" alt="Foto adicional 1">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/babyshower/babyshower2.jpg" alt="Foto adicional 2">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/babyshower/babyshower3.jpg" alt="Foto adicional 3">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/babyshower/babyshower4.jpeg" alt="Foto adicional 4">
                    </div>
                    <div class="foto-card">
                        <img src="../assets/img/eventos/babyshower/babyshower5.jpeg" alt="Foto adicional 5">
                    </div>
                </div>
